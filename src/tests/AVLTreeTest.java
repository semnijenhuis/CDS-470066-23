...
class AVLTreeTest {
    ...
    void avlAddAndSearchBW(){
        ...
        assertThrows(NullPointerException.class, () -> avlTree.searchID(1));
        assertThrows(NullPointerException.class, () -> avlTree.searchName("Long1"));
        assertThrows(NullPointerException.class, () -> avlTree.searchCode("ST1"));
    }
